...
import { changeHero } from 'features/Lobby/application/slice'
...
export const SelectHeroDialog: React.ForwardRefExoticComponent<Props & React.RefAttributes<HTMLDialogElement>> = React.forwardRef<HTMLDialogElement, Props>(({ onClose }, ref) => {
