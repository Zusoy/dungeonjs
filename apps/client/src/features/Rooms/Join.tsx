...
import { join, selectIsInError, selectLastErrorCode } from 'features/Rooms/slice'

const Join: React.ForwardRefExoticComponent<React.RefAttributes<HTMLDialogElement>> = React.forwardRef<HTMLDialogElement>((_props, ref) => {
