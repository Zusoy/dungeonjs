...
import { create } from 'features/Rooms/application/slice'
import { useDispatch } from 'react-redux'

export const CreateDialog: React.ForwardRefExoticComponent<React.RefAttributes<HTMLDialogElement>> = React.forwardRef<HTMLDialogElement>((_props, ref) => {
