...
const WarriorSkeleton: React.FC<JSX.IntrinsicElements['group']> = props => {
  const transform = React.useRef<THREE.Group>(null!)
  const { scene, materials, animations } = useGLTF('/arts/skeletons/characters/gltf/Skeleton_Warrior.glb') as unknown as GLTFResult
...
useGLTF.preload('/arts/skeletons/characters/gltf/Skeleton_Warrior.glb')

export default WarriorSkeleton
